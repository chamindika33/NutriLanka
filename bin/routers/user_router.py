...
def add_food_to_favorite_list(request:AddFavoriteItem):
    return userManager.add_food_record_to_favorite_list(request)

@router.get('/get-user-favourite-list')
def get_user_favourite_list(user_id:str):
    return userManager.get_user_favourite_food_list(user_id)